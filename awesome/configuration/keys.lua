...
awful.keyboard.append_global_keybindings({
	...
	awful.key({ mod, shift }, "n", function()
		awful.spawn(apps.default.network_manager)
	end, { description = "open nmtui", group = "app" }),
	...
	awful.key({ mod, alt }, "a", function()
		awful.client.focus.bydirection("left")
		bling.module.flash_focus.flashfocus(client.focus)
	end, { description = "focus left", group = "client" }),
	awful.key({ mod, alt }, "d", function()
	...
	awful.key({ ctrl, alt }, "c", function()
		awful.spawn.with_shell(apps.default.flameshot)
	end, { description = "flameshot take screenshot", group = "hotkeys" }),
...
---		end, { description = "toggle titlebar", group = "client" }),
		...
		awful.key({ mod, ctrl }, "q", function(c)
...
--- ~~~~~~~~~~~~~~~~~~~~~~~
awful.keyboard.append_global_keybindings({
	awful.key({ mod }, "a", awful.tag.viewprev, { description = "view previous", group = "tags" }),
	awful.key({ mod }, "d", awful.tag.viewnext, { description = "view next", group = "tags" }),
